...
import com.sanket.jobportal.repository.JobSeekerProfileRepository;
...
public class UsersService {
    ...
    private final RecruiterProfileRpository recruiterProfileRepository;
    private final PasswordEncoder passwordEncoder;

    @Autowired
    public UsersService(UsersRepository usersRepository, JobSeekerProfileRepository jobSeekerProfileRepository, RecruiterProfileRpository recruiterProfileRepository, PasswordEncoder passwordEncoder) {
